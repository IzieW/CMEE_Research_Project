...
nutrient B, where L changes every enviro.T timesteps
...
from stochastic_nutrient_T_flucL_B import *
import os
...
def run_simulations(i):
    ...
    if i < 40: # Split into three and run on different population sizes
        N=100
        name = "T_flucL_B_s"+str(i)+"l64L"+fluc+"T"+str(T)+"fixation"+str(fixation)+"N"+str(N)
