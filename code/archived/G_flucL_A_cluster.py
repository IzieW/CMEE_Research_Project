...
nutrient A, where L changes every g generatons.
...
from stochastic_nutrient_G_flucL_A import *
import os
...
def run_simulations(i):
    ...
    if i < 120: # Split into three and run on different population sizes
        N=100
        name = "G_flucL_A_s"+str(i)+"l64L"+fluc+"g"+str(g)+"T"+str(T)+"fixation"+str(fixation)+"N"+str(N)
