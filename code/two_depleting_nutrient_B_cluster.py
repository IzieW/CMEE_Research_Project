...
from two_depleting_nutrient_B import *
import os
...
def run_simulations(i):
    ...
    TL = [[n, t, l] for n in [10, 100, 1000, 10000, 100000] for t in [500, 1000, 10000] for l in [10, 15, 20, 30]]  # all combinations of T and L
    ...
    name = "two_depletion_nutrient_B_s"+str(i)+"l64L"+str(L)+"T"+str(T)+"N"+str(N)
